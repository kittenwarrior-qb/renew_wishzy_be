...
export class CreateChapterTable1762054277839 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "idx_chapter_created_by" ON "chapters"("created_by")`);
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "idx_chapter_course" ON "chapters"("course_id")`);
  }
